/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76d2f5fb838dd4856ebd1a16683fbae2)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	ASYNC_JOBS: Queue;
	AI: Ai;
	WIKI_SEARCH: AiSearchInstance;
	ENVIRONMENT: "production" | "development";
	AI_GATEWAY_ID: "nago-wiki-prod" | "nago-wiki-dev";
	ANSWER_MODEL: "@cf/zai-org/glm-4.7-flash";
	DEFAULT_KNOWLEDGE_MODE: "wiki_plus_general";
	ACCESS_AUDIENCE: "configure-before-deploy" | "configure-in-environment";
	...
	MCP_PUBLIC_ORIGIN: "https://configure-before-deploy.example" | "http://localhost:8787";
	WORKER_INTERNAL_URL: "https://configure-before-deploy.example" | "http://localhost:8787";
	PAGE_ROOM: DurableObjectNamespace<import("./src/index").PageRoom>;
	DISCORD_GATEWAY: DurableObjectNamespace<import("./src/index").DiscordGatewayContainer>;
	IMPORT_WORKFLOW: Workflow<Parameters<import("./src/index").ImportWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PageRoom" | "DiscordGatewayContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AI_GATEWAY_ID" | "ANSWER_MODEL" | "DEFAULT_KNOWLEDGE_MODE" | "ACCESS_AUDIENCE" | "ACCESS_ISSUER" | "ALLOW_DEVELOPMENT_IDENTITY" | "WORKSPACE_ID" | "BOOTSTRAP_OWNER_EMAIL" | "GOOGLE_CLIENT_ID" | "MCP_PUBLIC_ORIGIN" | "WORKER_INTERNAL_URL">> {}
}
