...
/** Canonical import-create payload. The Worker also accepts the legacy
 * `{ source: { type: "google_docs", documentId } }` Web payload. */
...
export const importJobSchema = z.object({
  ...
  previewMarkdown: z.string().nullable().optional(),
